...
int main() {
	//в первой строке input.txt N
	//далее вводим саму матрицу
	//output.txt в первой строке максимальная возможная производительность конвейера.
	//Во второй строке — номера станков, на которые должны быть распределены рабочие
